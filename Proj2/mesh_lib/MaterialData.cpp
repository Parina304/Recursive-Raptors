...
vector<double> calculateTempDistribution(double protectionThickness, double missionDuration, double dt, double dx, double initialExternalTemp) {
    ...
    double thickness = protectionThickness / 100.0;  // cm to m
    ...
    for (int t = 0; t < missionDuration; t += dt) {
        ...
        d[0] = initialExternalTemp;

        // No override for d[Nx - 1]; let it evolve naturally
...
double calculateRequiredProtectionThickness(double missionDuration) {
    ...
    double maxThickness = 20.0; // cm
    double currentThickness = (minThickness + maxThickness) / 2.0;
    double tolerance = 0.01;    // Tolerance in cm
...
int main() {
    ...
    double thickness1hr = calculateRequiredProtectionThickness(3600);  // 1 hour in seconds
    double thickness3hr = calculateRequiredProtectionThickness(10800); // 3 hours in seconds
    double thickness7hr = calculateRequiredProtectionThickness(25200); // 7 hours in seconds
    
    cout << "Required thermal protection thickness for 1 hour mission: " << thickness1hr << " cm" << endl;
    cout << "Required thermal protection thickness for 3 hour mission: " << thickness3hr << " cm" << endl;
    cout << "Required thermal protection thickness for 7 hour mission: " << thickness7hr << " cm" << endl;
